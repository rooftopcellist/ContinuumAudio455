...
if (isset($_POST['send'])) {
	...
	if (!$missing && !$errors) {
		...
		// Make the query:
		$sql = "SELECT firstName, emailAddr, pw, folder FROM Ca_Reg_Users WHERE emailAddr = :email";
...
img {
	...
	<figure><img src="images/Small_Logo.png" alt="Responsive image" width="150" height = "80" class = "img-responsive" style="vertical-align:bottom"></figure>
<body>
